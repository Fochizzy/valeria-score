drop function if exists public.delete_in_progress_session(uuid);
drop function if exists public.finish_game(uuid);

create function public.delete_in_progress_session(p_session_id uuid)
returns void
language plpgsql
as $$
declare
...
create function public.finish_game(p_session_id uuid)
returns void
language plpgsql
as $$
declare
